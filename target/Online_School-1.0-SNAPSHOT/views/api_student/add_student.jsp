...
<form action="/add_student" method="post">
    ...
    <label for="first_name">Name: </label><input type="text" id="first_name" name="first_name"required> <br>
    ...
    <label for="phone_number">Phone number:</label><input type="tel"id="phone_number"placeholder="+3(___)___-__-__"pattern="+3\s?[\(]{0,1}9[0-9]{2}[\)]{0,1}\s?\d{3}[-]{0,1}\d{2}[-]{0,1}\d{2}" name="phone_number" required>
    <br>
...
<nav>
    <ul>
        <li><a href="/course_list/for_student">Попередня сторінка</a></li>
        <li><a href="/student_list_page">Список студентів</a></li>
