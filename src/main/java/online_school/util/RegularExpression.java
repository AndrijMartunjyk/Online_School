...
public class RegularExpression {
    ...
    private static final String FIRST_OR_LAST_NAME_PATTERN = "^[A-Za-z]+$";
    private static final String ENGLISH_LETTER_PATTERN = "^[A-Za-z]{01}$";
    ...
    public static final Pattern letterPattern = Pattern.compile(ENGLISH_LETTER_PATTERN, Pattern.CASE_INSENSITIVE);
